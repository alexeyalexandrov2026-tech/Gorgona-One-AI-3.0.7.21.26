...
export const sportsbooks = [
  ...
  { id: 4, name: 'Caesars Sportsbook', slug: 'caesars', logo: 'CS', description: 'Premium sportsbook with strong brand integration and loyalty benefits.', website: 'https://www.caesars.com/sportsbook-and-casino', affiliate_link: 'https://www.caesars.com/sportsbook-and-casino', promo_code: '', bonus_offer: 'Promotional offers announced by market', state_availability: 'Available in select states', status: 'active' },
  { id: 5, name: 'Fanatics Sportsbook', slug: 'fanatics', logo: 'FN', description: 'Sportsbook focused on fan engagement and live event experiences.', website: 'https://sportsbook.fanatics.com', affiliate_link: 'https://sportsbook.fanatics.com', promo_code: '', bonus_offer: 'Offer details updated regularly', state_availability: 'Available in select states', status: 'active' },
