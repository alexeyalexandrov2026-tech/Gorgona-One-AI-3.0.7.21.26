...
//
// The English `summary` line is the one piece with no i18n equivalent. It is
// shown only where it is actually the guest's language; a localized card
// carries title + CTA and omits it, which keeps the frame in one language
